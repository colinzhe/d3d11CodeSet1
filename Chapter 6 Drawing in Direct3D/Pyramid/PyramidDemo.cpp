//***************************************************************************************
// PyramidDemo.cpp by Frank Luna (C) 2011 All Rights Reserved.
//
// Demonstrates rendering a colored Pyramid.
//
// Controls:
...
: D3DApp(hInstance), mPyramidVB(0), mPyramidIB(0), mFX(0), mTech(0),
...
void PyramidApp::BuildFX()
{
	...
	{
		MessagePyramidA(0, (char*)compilationMsgs->GetBufferPointer(), 0, 0);
...
void PyramidApp::BuildVertexLayout()
{
